...
# 1. Создать класс Coord (координата), который при инициализации будет получать координаты (х, у).
...
# (соответствует ли количество координат длине кораблика)
class Coord
    attr_accessor :coord_x, :coord_y, :ship_size
    def initialize (x, y, size)
        @ship_size = size
	for coord in (1..ship_size)
        @coord_x = x
        @coord_y = y
	end
    end
